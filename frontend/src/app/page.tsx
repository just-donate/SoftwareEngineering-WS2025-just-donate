...
export default function SearchPage() {
  ...
  return (
      <KeycloakProvider>
        <div className={`h-screen ${theme.background}`} style={{
          backgroundImage: 'url(https://lirp.cdn-website.com/58002456/dms3rep/multi/opt/IMG_6410-358b77c4-976cb433-1920w.jpg)',
          ...
          <main
            ...
            <div className={`${theme.card} p-6 rounded-lg shadow-lg w-full max-w-2xl mb-6`}>
              ...
              <p className="mb-4">
                JustDonate helps you track your donated money to an organization step by step and lets you see exactly
                what it is used for. By entering a tracking ID, you can directly access your dashboard. You should have
                received the ID via mail after donating to an organization using JustDonate.
              </p>
            </div>
